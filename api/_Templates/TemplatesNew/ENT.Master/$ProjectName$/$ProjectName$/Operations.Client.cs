...
namespace $ProjectName$ {
    ...
    partial class $DomainPrefix$$EntityName$ {
        ...
        public class Client_GetByID : slBaseObjectOperation {
            [slOperationMethod]
            public $DomainPrefix$$EntityName$Collection Execute(string ID) {                
                $DomainPrefix$$EntityName$Impl impl = new $DomainPrefix$$EntityName$Impl(AppContext);
                return ($DomainPrefix$$EntityName$Collection)impl.Client.GetByID(impl.entityRegName, "GetByID", ID);
            }
        }
